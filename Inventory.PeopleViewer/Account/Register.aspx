<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Inventory.PeopleViewer.Account.Register" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ValidationGroup="Create" ControlToValidate="txtFirstName"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:RequiredFieldValidator runat="server" ValidationGroup="Create" ControlToValidate="txtLastName"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <asp:RequiredFieldValidator InitialValue="0" ValidationGroup="Create" runat="server" ControlToValidate="ddlGender"
